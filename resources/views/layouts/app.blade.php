...
<head>
    ...
    <title>{{ config('app.name', 'Raffles Management System') }}</title>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.2.1/css/responsive.bootstrap4.min.css"   crossorigin="anonymous">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background-color: #b8d4fe;">
            <div class="container">
